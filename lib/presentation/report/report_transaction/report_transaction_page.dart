...
import 'package:kovio_coffee/presentation/report/report_transaction/report_transaction_export_excel.dart';
import 'package:kovio_coffee/presentation/report/report_transaction/report_transaction_export_pdf.dart';
import 'package:kovio_coffee/presentation/report/report_transaction/transaction_data_source.dart';
...
class ReportTransactionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Cell> columns = [
      Cell("No", 0.28),
      Cell("Reference No", 1),
      Cell("Transaction Date", 0.7),
      Cell("Branch Name", 1),
      Cell("Customer Name", 1.1),
      Cell("Cashier", 0.8),
