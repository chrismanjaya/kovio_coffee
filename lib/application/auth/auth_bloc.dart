...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc(this._authServices, this._userServices) : super(AuthState.initial());
  ...
  Stream<AuthState> mapEventToState(AuthEvent event) async* {
    yield* event.map(
      ...
      branchChanged: (e) async* {
        // 20210911 CM - Add Branch Changes to Firebase
        await _userServices.changeUserBranch(state.userModel, e.branchModel);
