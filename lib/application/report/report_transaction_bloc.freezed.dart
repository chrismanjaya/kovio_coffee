...
// ignore: unused_element
  _ReportTransactionState call(
    ...
    return _ReportTransactionState(
      ...
      listSoldProductReportModel: listSoldProductReportModel,
...
mixin _$ReportTransactionState {
  ...
  List<SoldProductReportModel> get listSoldProductReportModel;
...
class _$ReportTransactionStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object listSoldProductReportModel = freezed,
    ...
    return _then(_value.copyWith(
      ...
      listSoldProductReportModel: listSoldProductReportModel == freezed
          ? _value.listSoldProductReportModel
          : listSoldProductReportModel as List<SoldProductReportModel>,
...
class _$_ReportTransactionState implements _ReportTransactionState {
  const _$_ReportTransactionState(
      ...
      @required this.listSoldProductReportModel,
      ...
      : assert(listExpenseModel != null),
        ...
        assert(listSoldProductReportModel != null),
  ...
  @override
  final List<SoldProductReportModel> listSoldProductReportModel;
  @override
  ...
  @override
  String toString() {
    return 'ReportTransactionState(listExpenseModel: $listExpenseModel, listTransactionReportModel: $listTransactionReportModel, listSoldProductReportModel: $listSoldProductReportModel, transactionReportStatusModel: $transactionReportStatusModel, transactionFilterModel: $transactionFilterModel, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
        ...
        (other is _ReportTransactionState &&
            ...
            (identical(other.listTransactionReportModel,
                ...
                const DeepCollectionEquality().equals(
                    ...
                    listTransactionReportModel)) &&
            (identical(other.listSoldProductReportModel,
                    listSoldProductReportModel) ||
                const DeepCollectionEquality().equals(
                    other.listSoldProductReportModel,
                    listSoldProductReportModel)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(listSoldProductReportModel) ^
