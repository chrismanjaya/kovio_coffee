...
import 'package:kovio_coffee/domain/mapper/user_model_mapper.dart';
import 'package:kovio_coffee/domain/model/branch_model.dart';
import 'package:kovio_coffee/domain/model/user_model.dart';
import 'package:dartz/dartz.dart';
import 'package:kovio_coffee/domain/services/user/user_services.dart';
import 'package:kovio_coffee/infrastructure/model/branch.dart';
import 'package:kovio_coffee/infrastructure/model/group.dart';
import 'package:kovio_coffee/infrastructure/model/user_branches.dart';
import 'package:kovio_coffee/infrastructure/model/user_data.dart';
import 'package:kovio_coffee/infrastructure/repository/auth_repo.dart';
import 'package:kovio_coffee/infrastructure/repository/branch_repo.dart';
import 'package:kovio_coffee/infrastructure/repository/group_repo.dart';
import 'package:kovio_coffee/infrastructure/repository/user_branches_repo.dart';
import 'package:kovio_coffee/infrastructure/repository/user_repo.dart';
...
class UserServicesImp implements UserServices {
  ...
  Future<Either<String, Unit>> changeUserBranch(
      UserModel userModel, BranchModel branchModel) async {
    UserData userData = UserModelMapper().toUserData(userModel);
    // Update User Default Branch
    final updateUserDefaultBranch =
        await UserRepo().updateUserDefaultBranch(userData, branchModel.id);
    if (updateUserDefaultBranch.isLeft())
      return left(updateUserDefaultBranch.fold(
        (failure) => failure,
        (r) => null,
      ));
    return right(unit);
